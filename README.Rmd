...
We aim to learn more about Rstudio by following the instructions in this assignment.
During the assignment we will: answer questions, copy and paste code, and run the code in calculator.R.
